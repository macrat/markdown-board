---
name: code-review
description: コードベース全体をレビューし、技術的課題・アーキテクチャ・UI/UX・プロダクト方向性の観点から改善提案を行い、GitHub Issueとして起票する
disable-model-invocation: true
---

# コードレビュー & 改善提案スキル

このスキルは、コードベース全体を多角的にレビューし、改善提案をGitHub Issueとして起票するワークフローです。
